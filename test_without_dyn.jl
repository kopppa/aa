	...
	updateJD(k,l,B,bb)
      ...
      test=false;
            ...
            while test==false&&counter<100
				  ...
				  println("")
				  println(counter)
				  test=converge_adv(cumul1,cumul2,cumul3,10.0^(-5.0))
            ...
            push!(datafull,[betaprima,beta,n,h,J1,J3,s1,s3,m1,q1,chi1,m3,q3,chi3])
            writedlm(string("phase_sigma_grande3.dat"),datafull)
			#writedlm("trouble.dat",trouble_par)

end

infostring="betaprima,beta,n,h,J1,J3,s1,s3,m1,q1,chi1,m3,q3,chi3"
...
#for k in 0.1:1.02:7.4
	#println("J1=",k);
	#for l in 1.1:1.03:7.2
     	#println("J3=",l);
		fixsolve(0.1,-7.1,1.0,0.0)
	#end
#end
#for i in 0.1:1.0:10
#	fixsolve(1,-10,1,0.0)
